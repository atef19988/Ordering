---
description: Task 11 — README and one-page design note
---
...
3. @docs/tasks/task-11-readme-and-design-note.md — the spec for this task
...
- Tick the "Definition of done" boxes in `docs/tasks/task-11-readme-and-design-note.md`
