---
description: Task 4 — POST /api/orders with atomic stock and outbox
---
...
3. @docs/tasks/task-04-create-order.md — the spec for this task

Then implement it completely.

**Focus:** One transaction. Conditional UPDATE for stock. No process-local lock anywhere.
...
- Tick the "Definition of done" boxes in `docs/tasks/task-04-create-order.md`
