---
description: Task 6 — cancel with exactly-once stock restore
---
...
3. @docs/tasks/task-06-cancel-order.md — the spec for this task
...
- Tick the "Definition of done" boxes in `docs/tasks/task-06-cancel-order.md`
